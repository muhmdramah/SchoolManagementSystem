    ...
    public class CreateStudentValidator : AbstractValidator<CreateStudentCommand>
    {
        ...
        private void ApplyValidationRules()
        {
            ...
            RuleFor(x => x.StudentPhone)
                ...
                .Matches(@"^(\+201|01)\d{9}$").WithMessage(_stringLocalizer[SharedResourcesKeys.StudentPhoneNumberValidator]);

            RuleFor(x => x.DepartmentId)
                .GreaterThan(0).WithMessage(_stringLocalizer
                [SharedResourcesKeys.StudentDepartmentNumberMustBeGreaterThanZero]);
        }
